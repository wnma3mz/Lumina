...
class TestBasicLoad:
    def test_loads_host_and_port(self, tmp_path):
        cfg = Config.load(_write_config(tmp_path, {**_base_config(), "host": "0.0.0.0", "port": 9999}))
        assert cfg.host == "0.0.0.0"
        assert cfg.port == 9999

    def test_loads_provider_type(self, tmp_path):
        cfg = Config.load(_write_config(tmp_path, _base_config()))
    ...
    def test_loads_mlx_memory_nested_block(self, tmp_path):
        ...
        cfg = Config.load(_write_config(tmp_path, data))
