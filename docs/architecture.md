...
- `lumina/providers/mlx_loader.py` — 模型加载 + offload 分层
- `lumina/providers/local_vlm.py` — VLM 图片输入规范化与推理
- `lumina/providers/local_offload.py` — CPU embedding offload 前向分支
